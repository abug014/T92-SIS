...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <div class="d-flex align-items-center ms-auto">
        <div class="nav-item dropdown user-info d-flex align-items-center bg-success-a text-white px-3">
            <div class="d-flex flex-column me-2">
                <strong class="text-truncate d-block">{{ Auth::user()->name }}</strong>
                <span class="small text-truncate d-block">({{ Auth::user()->email }})</span>
            </div>
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="{{ route('subjects.index') }}">
                        <div class="sb-nav-link-icon"><i class="fas fa-fw fa-book"></i></i></div>
                        Subjects
                    </a>
                </div>
            </div>
