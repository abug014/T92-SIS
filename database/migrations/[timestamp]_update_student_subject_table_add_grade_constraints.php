...
return new class extends Migration
{
    public function up()
    {
        ...
        // Modify the grade column to ensure consistent decimal handling
        Schema::table('student_subjects', function (Blueprint $table) {
            $table->decimal('grade', 3, 2)->nullable()->change();
        });

        // Add the new check constraint with CAST to ensure decimal comparison
        DB::statement("
